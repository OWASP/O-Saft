...
SID="@(#) INSTALL-template.sh 3.73 25/04/07 00:05:30"
try=''
ich=${0##*/}
dir=${0%/*}
...
while [ $# -gt 0 ]; do
	case "$1" in
	  ...
	  '--version')
		...
		exit 0
		;;
	  '+VERSION')   echo 3.73 ; exit;        ;; # for compatibility to $osaft_exe
	  3.73 | 3* | 4*) ;; # ignore version number
...
echo_info "$0 3.73 $mode $src_txt $inst_directory "
