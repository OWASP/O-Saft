...
(
  ...
  # 3.
  \echo ''
  \echo 'our $osaft_standalone = 1; # inserted by ÷e 3.3'
...
# use base qw(Exporter);
  ...
  for module in $_osaft_lib; do
	...
	# each package enclosed in { .. } to avoid Perl warning:
	#   variable $... masks earlier declaration in same scope ...
	\echo "{# $f"
