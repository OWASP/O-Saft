...
#?
#? VERSION
#?      @(#) Makefile 3.37 24/08/14 10:40:18
#?
#? AUTHOR
...
_INST.genbytext = generated data by Makefile 3.37 from $(SRC.inst)
_INST.gen_text  = generated data from Makefile 3.37
