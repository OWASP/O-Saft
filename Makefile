...
#?
#? VERSION
#?      @(#) Makefile 2.31 23/08/09 18:07:39
#?
#? AUTHOR
...
_INST.genbytext = generated data by Makefile 2.31 from $(SRC.inst)
_INST.gen_text  = generated data from Makefile 2.31
