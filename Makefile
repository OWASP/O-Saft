...
#?
#? VERSION
#?      @(#) Makefile 3.36 24/08/12 21:46:45
#?
#? AUTHOR
...
_INST.genbytext = generated data by Makefile 3.36 from $(SRC.inst)
_INST.gen_text  = generated data from Makefile 3.36
