...
Makefile*. This is done to keep other makefiles as simple as possible, and
...
The sub-headers in L</O-Saft Makefile Annotations> are referenced from all
other makefiles.

=head1 VERSION

@(#) Makefile.pod 1.29 19/11/16 13:09:47
...
describes some GNU Make behaviours used in the project.
...
to use each of these makefiles by its own, like:
