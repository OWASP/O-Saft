...
@(#) Makefile.pod 1.28 19/11/16 02:37:31
...
* using shell's test commands inside Makefile is tricky,  as single quotes
  instead of double quote must be used  for test -n '$var'
