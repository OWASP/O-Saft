...
all target for developemnt can be used there also.
...
All  help.*  targets are for ducumentation of the makefile's targets.
...
@(#) Makefile.pod 1.49 22/06/19 10:30:26
...
Naming conventions for targets:
    ...
    testcmd-TYP-*   - targets for testing tools commands in Makefile.TYP
