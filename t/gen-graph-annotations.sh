...
out=o-saft_graph-annotations
optv=

ALL_src=`make e-ALL.src`
ALL_gen=`make e-ALL.gen`
SRC_ignore='
	tags
	CHANGES
	yeast.pl
...
'
# $ALL_gen  ergibt keinen Sinn, nur contrib/o-saft-standalone.pl
...
#TODO:  neet to search and santise L<anotation>
	  ...
	  for _src in $ALL_nopod ; do
        ...
        \echo "# generated by Àç{U 1.3"       >>$_out.graph
