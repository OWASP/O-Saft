...
set cfg(SID)    "@(#) o-saft.tcl 1.214 19/07/20 12:04:13"
set cfg(mySID)  "$cfg(SID) Spring Edition 2019"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {1.214}
...
proc osaft_write_rc {} {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 1.214 19/07/20 12:04:13
 #?
 #? AUTHOR
