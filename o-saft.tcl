...
set cfg(SID)    "@(#) o-saft.tcl 3.8 24/01/26 17:43:58"
...
set cfg(IMG)    $cfg(lib-dir)/o-saft-img.tcl   ;# where to find image data
...
proc create_win   {parent title cmd} {
    ...
    switch $cmd {
      ...
      default { pwarn "create_win called with wrong command »$cmd«"; return }
        ...
        # also  lib/ODoc.pm  and  lib/doc/help.txt
...
proc osaft_write_rc     {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 3.8 24/01/26 17:43:58
 #?
 #? AUTHOR
