...
set cfg(SID)    "@(#) o-saft.tcl 1.269 22/04/02 12:33:42"
set cfg(mySID)  "$cfg(SID) Spring Edition 2022"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {1.269}
...
proc create_table {parent content}  {
    ...
    foreach line [split $content "\n"] {
        ...
        if {[regexp {^[=#]+} $line]} {
            ...
            if {[regexp {\sChecking.*Ciphers} $line]} {
                # +cipher header line containing protocol, like:
                # === Checking TLSv12 Ciphers ... ===
                set ssl [lindex [split $line " "] 2];# remember current protocol
                #dbx# puts "#dbx# C $ssl"
...
proc osaft_write_rc     {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 1.269 22/04/02 12:33:42
 #?
 #? AUTHOR
