...
# + or -
set cfg(SID)    "@(#) o-saft.tcl 3.49 25/02/27 13:23:04"
set cfg(mySID)  "$cfg(SID) Spring Edition 2025"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {3.49}
...
proc self_write_rc      {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 3.49 25/02/27 13:23:04
 #?
 #? AUTHOR
...
# FIXME: if {[_isaqua]} ...
    if {"O-Saft" ne $prg(TKPOD)} {
        ...
        if {[string length    $binary]} {
            ...
            msg:append warning $msg
            _message warning "(gui_init:prg): --pod" $msg
