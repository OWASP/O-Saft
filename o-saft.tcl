...
set cfg(SID)    "@(#) o-saft.tcl 1.235 21/01/14 01:13:04"
set cfg(mySID)  "$cfg(SID) Winter Edition 2021"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {1.235}
...
proc osaft_write_rc     {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 1.235 21/01/14 01:13:04
 #?
 #? AUTHOR
