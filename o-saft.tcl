...
set cfg(SID)    "@(#) o-saft.tcl 2.22 22/06/27 13:31:30"
set cfg(mySID)  "$cfg(SID) Spring Edition 2022"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {2.22}
...
set cfg(docs-help-all)  "--help=commands --help=opts $cfg(docs-help)"
                                # file extensions for files from ./docs/ used in osaft_write_docs()
...
proc osaft_write_rc     {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 2.22 22/06/27 13:31:30
 #?
 #? AUTHOR
