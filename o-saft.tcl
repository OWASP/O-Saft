...
#?      rules. Therefore following differences to standard Tcl/Tk are known:
#?
#?      "Confirm" in dialogs is mandatory, see  cfg(confirm)  in .$0 .
#?
#?      Aqua uses a small resize icon in the lower right corner of windows.
#?      Therfore Tk object must be shifted left, the amount of pixels for this
#?      shift can be configured with  myX(rpad)  in .$0 .
#?
...
# + or -
set cfg(SID)    "@(#) o-saft.tcl 3.59 25/03/03 16:42:59"
set cfg(mySID)  "$cfg(SID) Spring Edition 2025"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {3.59}
...
set prg(BROWSERS)   "firefox chrome chromium iceweasel konqueror mozilla \
    ...
    # the .app-directory, or example: /Applications/Safari.app)
...
proc self_rc:print   {} {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 3.59 25/03/03 16:42:59
 #?
 #? AUTHOR
