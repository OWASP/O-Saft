...
set cfg(SID)    "@(#) o-saft.tcl 2.48 23/04/28 01:14:42"
set cfg(mySID)  "$cfg(SID) Spring Edition 2023"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {2.48}
...
set cfg(EXEC)   -1 ;# count executions, used for object names
    ...
    #               # start at 3, see create_main_tabs()
...
proc create_main_tabs          {parent w} {
    ...
    pack [button    $tab_cmds.saveconfig -command "osaft_save $tab_cmds {CFG} 0" ] -side left
    pack [button    $tab_opts.saveconfig -command "osaft_save $tab_opts {CFG} 0" ] -side left
...
proc osaft_write_rc     {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 2.48 23/04/28 01:14:42
 #?
 #? AUTHOR
