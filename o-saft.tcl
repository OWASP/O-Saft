...
set cfg(SID)    "@(#) o-saft.tcl 2.19 22/04/22 23:45:03"
set cfg(mySID)  "$cfg(SID) Spring Edition 2022"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {2.19}
...
# RC-END }
set cfg(docs-help)      {--help=alias --help=data --help=checks --help=regex --help=rfc --help=glossar +help}
                                # file extensions for files from ./docs/ used in osaft_read_data() and osaft_help()
                                # missing: --help=text --help=ourstr --help=compliance
                                # missing because too much data: --help=range
set cfg(docs-help-all)  "--help=commands --help=opts $cfg(docs-help)"
                                # file extensions for files from ./docs/ used in osaft_write_data()
...
proc osaft_write_rc     {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 2.19 22/04/22 23:45:03
 #?
 #? AUTHOR
...
proc osaft_help   {}    {
    ...
    foreach mode $cfg(docs-help) {
        if {[regexp {[+]help} $mode]} { continue } ;# already read
        set txt ""
...
proc config_read  {}    {
    ...
    set cfg(OPTS) [osaft_read_data $norc "--help=opt"]
...
proc gui_init     {}    {
    ...
    foreach bin " $__native $prg(TKPOD)" {
