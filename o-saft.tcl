...
set cfg(SID)    "@(#) o-saft.tcl 1.251 21/04/29 12:27:30"
set cfg(mySID)  "$cfg(SID) Spring Edition 2021"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {1.251}
...
proc osaft_write_rc     {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 1.251 21/04/29 12:27:30
 #?
 #? AUTHOR
...
proc osaft_get_data {norc mode} {
    ...
    set txt  ""
    if {0==$cfg(docs-exe)} {
        set file "docs/$cfg(O-Saft).$mode" ;# TODO: directory hardcoded
