...
set cfg(SID)    "@(#) o-saft.tcl 2.54 23/11/16 11:47:25"
set cfg(mySID)  "$cfg(SID) Autumn Edition 2023"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {2.54}
...
set myX(geoF)   "700x700"      ;# geometry and position of Filter    window
...
set cfg(docs-src)   {file}     ;# file:    read configuration of commands and
                                #          options from static files in ./docs/
...
proc osaft_write_rc     {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 2.54 23/11/16 11:47:25
 #?
 #? AUTHOR
