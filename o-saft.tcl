...
# + or -
set cfg(SID)    "@(#) o-saft.tcl 3.57 25/03/03 11:59:46"
set cfg(mySID)  "$cfg(SID) Spring Edition 2025"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {3.57}
...
proc self_rc:print   {} {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 3.57 25/03/03 11:59:46
 #?
 #? AUTHOR
...
proc gui_init:prg {start} {
    ...
    _dbx 2 "{}{"
    global prg
    foreach bin "$prg(BROWSERS) $start" {
...
proc gui_init       {}  {
    ...
    switch -nocase [tk windowingsystem] {
        {Aqua}  { set __native "open" ; gui_init:aqua }
