...
set cfg(SID)    "@(#) o-saft.tcl 2.55 23/12/28 18:48:14"
set cfg(mySID)  "$cfg(SID) Autumn Edition 2023"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {2.55}
 ...
 **INFO	-exact	0	blue	{}	{}	0	**INFO	line  **INFO (information from _ME_)
...
proc osaft_write_rc     {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 2.55 23/12/28 18:48:14
 #?
 #? AUTHOR
