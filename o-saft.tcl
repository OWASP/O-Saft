...
set cfg(SID)    "@(#) o-saft.tcl 3.10 24/01/27 09:58:21"
set cfg(mySID)  "$cfg(SID) Winter Edition 2024"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {3.10}
...
proc osaft_write_rc     {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 3.10 24/01/27 09:58:21
 #?
 #? AUTHOR
...
puts "##set help = osaft_read_data '' '--help'"
