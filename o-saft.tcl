...
#.      --test-flow     - print information about program flow (comments in code)
#.      --test-procs    - print all proc definitions
#.      --test-descr    - print all proc definitions and their description
...
#.                      - these lines are used by  --test-descr  option
#.          lines starting with  ##
#.                      - these lines are used by  --test-flow  option
#.          lines with  ;#
...
set cfg(SID)    "@(#) o-saft.tcl 1.223 19/08/26 12:12:28"
set cfg(mySID)  "$cfg(SID) Spring Edition 2019"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {1.223}
...
proc osaft_write_rc     {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 1.223 19/08/26 12:12:28
 #?
 #? AUTHOR
...
foreach arg $argv {
    switch -glob $arg {
        ...
        --test-flow   -
        --testflow    { puts [osaft_procs FLOW]; exit; }
        --test-descr  -
        --testdescr   { puts [osaft_procs DESC]; exit; }
        --test-procs  -
        --testprocs   { puts [osaft_procs PROC]; exit; }
