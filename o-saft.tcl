...
set cfg(SID)    "@(#) o-saft.tcl 2.42 23/04/27 18:08:46"
set cfg(mySID)  "$cfg(SID) Spring Edition 2023"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {2.42}
...
proc create_main_tabs          {parent w} {
    ...
    pack [button    $tab_opts.saveresult -command "osaft_save $tab_opts {CFG} 0" ] -side left
...
proc osaft_write_rc     {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 2.42 23/04/27 18:08:46
 #?
 #? AUTHOR
