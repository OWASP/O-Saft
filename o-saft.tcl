...
proc _isempty     {str} { if { [regexp {^\s*$} $s]} { return 1 }; return 0; }
...
# + or -
set cfg(SID)    "@(#) o-saft.tcl 3.41 25/02/26 10:42:01"
set cfg(mySID)  "$cfg(SID) Spring Edition 2025"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {3.41}
...
proc self_write_rc      {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 3.41 25/02/26 10:42:01
 #?
 #? AUTHOR
