...
# + or -
set cfg(SID)    "@(#) o-saft.tcl 3.42 25/02/26 11:00:55"
set cfg(mySID)  "$cfg(SID) Spring Edition 2025"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {3.42}
...
proc self_write_rc      {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 3.42 25/02/26 11:00:55
 #?
 #? AUTHOR
...
## 23feb25 Liste in global prg definieren
    foreach bin " $start $prg(BROWSERS)" {
