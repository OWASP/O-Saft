...
# + or -
set cfg(SID)    "@(#) o-saft.tcl 3.35 25/02/25 19:54:23"
set cfg(mySID)  "$cfg(SID) Spring Edition 2025"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {3.35}
...
proc osaft_write_rc     {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 3.35 25/02/25 19:54:23
 #?
 #? AUTHOR
