...
set cfg(SID)    "@(#) o-saft.tcl 3.16 24/05/27 14:17:10"
set cfg(mySID)  "$cfg(SID) Winter Edition 2024"
                 # contribution to SCCS's "what" to avoid additional characters
set cfg(VERSION) {3.16}
...
proc osaft_write_rc     {}  {
 ...
 #?
 #? VERSION
 #?      @(#) .o-saft.tcl generated by 3.16 24/05/27 14:17:10
 #?
 #? AUTHOR
