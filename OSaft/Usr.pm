...
my  $SID_usr        = "@(#) Usr.pm 2.1 24/01/07 12:51:21";
...
OSaft::Usr.pm - module for L<o-saft.pl|o-saft.pl>'s user definable functions

=head1 SYNOPSIS

=over 2

=item use q{OSaft::Usr.pm};     # in perl code

=item require q{OSaft/Usr.pm};  # in perl code

=item OSaft/Usr.pm --help       # on command-line will print help
