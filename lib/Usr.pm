...
my  $SID_usr        = "@(#) Usr.pm 3.2 24/01/08 17:17:45";
...
Usr.pm - module for L<o-saft.pl|o-saft.pl>'s user definable functions

=head1 SYNOPSIS

=over 2

=item use q{Usr.pm};        # in perl code

=item require q{Usr.pm};    # in perl code

=item Usr.pm --help         # on command-line will print help
