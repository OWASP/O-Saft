...
Text -- common texts for O-Saft and related tools
...
=item use Text;         # in perl code

=item Text.pm --help    # on command-line will print help
...
All variables and methods are defined in the  Text  namespace.
