...
###
--cfg_cmd=quick=selected cipher sslversion hassslv2 hassslv3 export rc4_cipher pfs_cipher beast crime freak heartbleed logjam lucky13 poodle rc4 sloth fingerprint_hash fp_not_md5 sha2signature pub_encryption email serial subject dates verify heartbeat expansion compression hostname hsts_sts crl resumption renegotiation
...
###
--cfg_cmd=vulns=beast breach crime freak heartbleed logjam lucky13 poodle rc4 sloth time hassslv2 hassslv3 pfs_cipher session_random
